...
def print_2matrix_pretty(matrix1, matrix2, prefix): # print two 4x4 matrix in a pretty way side by side
    if prefix:
        print(prefix)
    for i in range(4):
        print(" ".join(f"{matrix1[i][j]:02X}" for j in range(4)), "  |  ", " ".join(f"{matrix2[i][j]:02X}" for j in range(4)))
...
class AES(object):
    ...
    def encrypt_diff(self, plaintext_a, plaintext_b):
        ...
        for i in range(1, self.n_rounds):
            ...
            #print("Round", i)
            #print_2matrix_pretty(plain_state_a, plain_state_b, "SubBytes A | B:")
            ...
            #print_2matrix_pretty(plain_state_a, plain_state_b, "ShiftRows A | B:")
            ...
            #print_2matrix_pretty(plain_state_a, plain_state_b, "MixColumns A | B:")
            ...
            #print_2matrix_pretty(plain_state_a, plain_state_b, "AddRoundKey A | B:")
